...
export default {
  ...
  methods: {
    ...
    //  * 發送瀏覽器通知
    //  */
    // private sendNotification(recrod: ExtendChatRecord) {
    ...
    // * 轉接客服
    // */
    // private switchUser(message: ChatSwitchUser) {
    ...
    //  * 選擇表情符號
    //  */
    // public onEmojiSelect = (emoji: EmojiData) => {
    ...
    //  * 重傳
    //  */
    // public reSend(record: ExtendChatRecord) {
    //   record.fail = false;
    ...
    //  * 實際發送
    //  */
    // private doSend(record: ExtendChatRecord) {
    //   this.sending++;
    ...
    //  * 執行上傳
    //  */
    // private doUpload(record: ExtendChatRecord) {
    //   this.sending++;
    //   this.cdf.markForCheck();
    //   ChatService.upload({
    //     file: record.file
    ...
    //   oldMessage: ExtendChatRecord
    //   , result: IAjaxManagerResult<ChatMessage>
    // ) {
    //   this.sending--;
    //   if (result.success) {
    ...
    //  * 發送中訊息
    //  */
    // private appendSendingRecord(
    //   record: ExtendChatRecord
    // ) {
    ...
    //  * @param text
    //  */
    // private buildText(text: string): ExtendChatRecord {
    //   return {
    //     chatTime: 0
    //     , chatId: 0
    //     , id: 0
    ...
    //  * @param file
    //  */
    // private buildUpload(file: File): ExtendChatRecord {
    //   return {
    //     chatTime: 0
    //     , chatId: 0
    //     , id: 0
    ...
    //  * 機器客服訊息是否為空
    //  */
    // public isBotRecordEmpty(record: ExtendChatRecord) {
    ...
    //  * 取得知識庫解答   *fakeSend
    //  */
    // public getKnowledgeSolution(id: number, problem: string) {
    ...
    //  * 選擇分數
    //  */
    // public changeScore(chat: Chat, score: number) {
    ...
    //  * @param record
    //  */
    // public showImage(record: ExtendChatRecord | ExtendChatRecord) {
    //   this.currentRecord = record;
    //   this.dialog.open();
    //   if(this.isQQ) this.cdf.detectChanges();
    // }

    // public resize(multi: Number) {
    ...
    //  * @param record
    //  */
    // public download(record: ExtendChatRecord | ExtendChatRecord) {
    ...
    //  * @param record
    //  */
    // public progress(record: ExtendChatRecord) {
    ...
    //  * @param record
    //  */
    // public getFileSize(record: ExtendChatRecord): string {
    ...
    //  * @param type
    //  */
    // private getFileType(type: string): number {
    ...
    //  * @param record
    //  */
    // public showPortrait(record: ExtendChatRecord): boolean {
    ...
    //  * @param record
    //  */
    // public getPortrait(record: ExtendChatRecord): string {
    ...
    //  */
    // @TryCatchTrace()
    // public getMessageClassName(record: ExtendChatRecord) {
    ...
    //  * @param record
    //  */
    // public getMessageTime(record: ExtendChatRecord) {
    ...
    //  * @param record
    //  */
    // public getTimeFormat(time: number) {
    ...
    //  * @param record
    //  */
    // public getMessageName(record: ExtendChatRecord) {
    //   switch (record.sendType) {
    //     case ChatRecordSendType.SYSTEM:
    //       return '系统讯息';
    //     case ChatRecordSendType.CONSULTANT:
    ...
    // private findFirstChatRecord(): ExtendChatRecord {
    ...
    // }
    // private findLastChatRecordByLog() {
    ...
    //  * @param chat
    //  */
    // private appendChats(chats: Chat[]) {
    //   if (!chats) { return; }
    //   for (let i in chats) {
    ...
    // private appendFormat(record: ExtendChatRecord) {
    ...
    //  * @param record
    //  */
    // private appendChatRecord(record: ExtendChatRecord): number {
    //   if (!record) { return; }
    ...
    //  * @param records
    //  */
    // private appendFirstChatRecord(records: ExtendChatRecord[]): number {
    //   if (!records) { return; }
    //   let record;
    ...
    //  * @param records
    //  */
    // private appendLastChatRecord(records: ExtendChatRecord[]): number {
    //   if (!records) { return; }
    //   let record;
    //   let storage;
    //   let c = 0;
    ...
    //  * @param array
    //  */
    // private initChatStroage(array: Chat[]) {
    ...
    //  * @param array
    //  */
    // private initChatRecordStroage(array: ExtendChatRecord[]) {
